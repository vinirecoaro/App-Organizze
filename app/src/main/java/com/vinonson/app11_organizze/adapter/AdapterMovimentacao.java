package com.vinonson.app11_organizze.adapter;
...
public class AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLista = LayoutInflater.from(parent.getContext()).inflate(com.vinonson.app11_organizze.R.layout.adapter_movimentacao, parent, false);
